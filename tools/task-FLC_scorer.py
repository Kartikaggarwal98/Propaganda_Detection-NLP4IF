...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Scorer for Task FLC on the Propaganda Techniques Corpus. If only -s option is provided, only some checks on the submitted file is performed.")
